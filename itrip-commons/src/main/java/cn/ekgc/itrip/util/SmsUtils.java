...
public class SmsUtils {
	 ...
	 */
	@Async
	public void sendActivationCodeByCloopen(String cellphone, String activationCode) throws Exception {
		...
		String[] datas = {activationCode, String.valueOf(ConstantUtils.MAIL_EXPIRE), "变量3"};
